...
import {FeatDetails} from './FairpointDetails.js';
...
export class Fairpoint extends React.Component {
  ...
  render() {
    return(
      <div>
        <img src={"https://rawgit.com/gaschw3/dnd-react/master/src/images/"+this.props.params.area+".jpg"} alt="" usemap="#Map" />
        <map name="Map" id="Map">
          <area alt="" title="" href="#" shape="poly" coords="1098,212,1075,290,1170,317,1183,194" />
          <area alt="" title="" href="#" shape="poly" coords="1098,509,1053,569,1084,650,1138,684,1201,708,1336,620,1326,543,1245,495,1146,497" />
